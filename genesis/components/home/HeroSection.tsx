  ...
  return (
    <section className="relative min-h-[80dvh] flex flex-col items-center justify-center text-center py-12">
      ...
      <div className="relative group mb-12">
        <div className="absolute inset-[-20%] border-[2px] border-dashed border-secondary/20 rounded-full animate-rotate-slow pointer-events-none flex items-center justify-center">
        ...
        <Image
          ...
          width={450}
          height={450}
          className="h-80 md:h-[450px] w-auto relative z-10 drop-shadow-[0_0_50px_rgba(233,195,73,0.3)] transition-transform duration-700 hover:scale-105"
          priority
        />
      </div>
