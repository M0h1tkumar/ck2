    ...
    <section className="relic-card overflow-hidden border-l-2 border-primary">
      <div className="grid grid-cols-1 md:grid-cols-2">
        <div className="p-4 sm:p-8 md:p-12 space-y-6 md:space-y-8">
          ...
          <h3 className="text-xl sm:text-3xl md:text-4xl font-black text-on-surface leading-tight uppercase">
            Project: VEDAS II
            <br />
          ...
          <div className="flex flex-col sm:flex-row gap-4">
            <div className="bg-surface-container p-3 sm:p-4 flex-1 text-center sm:text-left">
              <span className="text-secondary text-xl sm:text-2xl font-black">94%</span>
              <p className="text-[10px] sm:text-xs uppercase text-on-surface-variant">Accuracy</p>
            </div>
            <div className="bg-surface-container p-3 sm:p-4 flex-1 text-center sm:text-left">
              <span className="text-secondary text-xl sm:text-2xl font-black">2.4TB</span>
              <p className="text-[10px] sm:text-xs uppercase text-on-surface-variant">Data Index</p>
            </div>
          </div>
        ...
        <div className="bg-primary-container/20 relative flex items-center justify-center p-6 sm:p-12">
