...
function drawNebulas(energy, t) {
    ...
    for (let i = 0; i < nebulaCount; i++) {
        ...
        const ang = nebula.angle + t * nebula.speed * nebula.dir;
        const dist = radius * nebula.dist;
        const x = cx + Math.cos(ang) * dist;
        const y = cy + Math.sin(ang) * dist * 0.88;
        const r = radius * nebula.size;
        const alpha = (Math.sin(t * nebula.speed * 2.2 + i) * 0.3 + 0.7) * nebula.alpha * energy;
